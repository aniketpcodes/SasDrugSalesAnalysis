...
/* Product-wise Average Sale & Total Net Revenue (their PROC REPORT with aliases) */
title j=Center "Product wise Average Sale, Total Sales Per Product & Net Revenue Analysis";
