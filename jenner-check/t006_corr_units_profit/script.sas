...
/* Correlation of Units Sold with Net Revenue and Profit (their PROC CORR) */
title j=Center "Correlation Analysis Between Units Sold with Net revenue and Profit";
Proc corr data=Sales_Derivation nomiss nosimple noprob;
	var Units_Sold;
